...
import static io.finarkein.fiul.notification.ServiceConstants.FIUL_CALLBACK_WEB_CLIENT_QUALIFIER;
...
public class CallbackWebClientConfig {
    ...
    @Bean
    public WebClient webhookClientQualifier(@Value("${" + FIUL_CALLBACK_WEB_CLIENT_QUALIFIER + "}") String webclientName,
